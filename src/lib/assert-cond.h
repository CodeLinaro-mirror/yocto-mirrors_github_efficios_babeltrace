...
#define _BT_ASSERT_PRE_PLUGIN_PROVIDER_SET_NAME	"Plugin provider set"
#define _BT_ASSERT_PRE_PLUGIN_PROVIDER_SET_ID	"plugin-provider-set"

#define BT_ASSERT_PRE_PLUGIN_PROVIDER_SET_NON_NULL(_plugin_provider_set) \
	BT_ASSERT_PRE_NON_NULL(_BT_ASSERT_PRE_PLUGIN_PROVIDER_SET_ID, (_plugin_provider_set), \
		_BT_ASSERT_PRE_PLUGIN_PROVIDER_SET_NAME)

#define _BT_ASSERT_PRE_PLUGIN_PROVIDER_SET_OUT_NAME			\
	_BT_ASSERT_PRE_PLUGIN_PROVIDER_SET_NAME " (output)"
#define _BT_ASSERT_PRE_PLUGIN_PROVIDER_SET_OUT_ID			\
	_BT_ASSERT_PRE_PLUGIN_PROVIDER_SET_ID "-output"

#define BT_ASSERT_PRE_PLUGIN_PROVIDER_SET_OUT_NON_NULL(_plugin_provider_set) \
	BT_ASSERT_PRE_NON_NULL(_BT_ASSERT_PRE_PLUGIN_PROVIDER_SET_OUT_ID, (_plugin_provider_set), \
		_BT_ASSERT_PRE_PLUGIN_PROVIDER_SET_OUT_NAME)
